...
describe('Post e2e test', () => {
  ...
  it('should create an instance of Post', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-06-22T05:33').invoke('val').should('equal', '2021-06-22T05:33');


    cy.get(`[data-cy="publicationDate"]`).type('2021-06-22T21:42').invoke('val').should('equal', '2021-06-22T21:42');
