...
describe('Appuser e2e test', () => {
  ...
  it('should create an instance of Appuser', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-06-22T20:56').invoke('val').should('equal', '2021-06-22T20:56');
    ...
    cy.get(`[data-cy="birthdate"]`).type('2021-06-23T02:36').invoke('val').should('equal', '2021-06-23T02:36');
