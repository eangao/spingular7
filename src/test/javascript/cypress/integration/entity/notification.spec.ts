...
describe('Notification e2e test', () => {
  ...
  it('should create an instance of Notification', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-06-23T00:09').invoke('val').should('equal', '2021-06-23T00:09');


    cy.get(`[data-cy="notificationDate"]`).type('2021-06-23T04:15').invoke('val').should('equal', '2021-06-23T04:15');
