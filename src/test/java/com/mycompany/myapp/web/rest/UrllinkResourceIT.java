...
import com.mycompany.myapp.repository.UrllinkRepository;
import com.mycompany.myapp.service.criteria.UrllinkCriteria;
import com.mycompany.myapp.service.dto.UrllinkDTO;
import com.mycompany.myapp.service.mapper.UrllinkMapper;
...
class UrllinkResourceIT {
    ...
    void createUrllink() throws Exception {
        ...
        restUrllinkMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(urllinkDTO)))
    ...
    void putWithMissingIdPathParamUrllink() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restUrllinkMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(urllinkDTO)))
    ...
    void patchWithMissingIdPathParamUrllink() throws Exception {
        ...
        restUrllinkMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(urllinkDTO))
            )
            .andExpect(status().isMethodNotAllowed());
