...
class ConfigVariablesResourceIT {
    ...
    void createConfigVariables() throws Exception {
        ...
        restConfigVariablesMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(configVariablesDTO))
            )
    ...
    void putWithMissingIdPathParamConfigVariables() throws Exception {
        ...
        restConfigVariablesMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(configVariablesDTO))
            )
