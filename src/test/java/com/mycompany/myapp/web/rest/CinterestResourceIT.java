...
import com.mycompany.myapp.domain.Cinterest;
import com.mycompany.myapp.domain.Community;
import com.mycompany.myapp.repository.CinterestRepository;
import com.mycompany.myapp.service.CinterestService;
import com.mycompany.myapp.service.criteria.CinterestCriteria;
import com.mycompany.myapp.service.dto.CinterestDTO;
import com.mycompany.myapp.service.mapper.CinterestMapper;
...
class CinterestResourceIT {
    ...
    void createCinterest() throws Exception {
        ...
        restCinterestMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(cinterestDTO)))
    ...
    void putWithMissingIdPathParamCinterest() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCinterestMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(cinterestDTO)))
    ...
    void patchWithMissingIdPathParamCinterest() throws Exception {
        ...
        restCinterestMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(cinterestDTO))
            )
            .andExpect(status().isMethodNotAllowed());
