...
public class Frontpageconfig implements Serializable {
    ...
    public Frontpageconfig id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public Long getFeaturedArticles10() {
        return this.featuredArticles10;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Frontpageconfig)) {
            return false;
        }
        return id != null && id.equals(((Frontpageconfig) o).id);
    }
