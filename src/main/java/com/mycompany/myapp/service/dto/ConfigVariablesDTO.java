...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.ConfigVariables} entity.
 */
public class ConfigVariablesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigVariablesDTO)) {
            return false;
        }
        ...
        return Objects.equals(this.id, configVariablesDTO.id);
    }
