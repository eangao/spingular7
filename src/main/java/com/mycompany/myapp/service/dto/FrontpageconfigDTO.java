...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.Frontpageconfig} entity.
 */
public class FrontpageconfigDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FrontpageconfigDTO)) {
            return false;
        }
        ...
        return Objects.equals(this.id, frontpageconfigDTO.id);
    }
